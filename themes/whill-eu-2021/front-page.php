  ...
  <div class="c-full-row home-awards">
    <div class="p-band p-band_highlight">
      <div class="p-page-content">
        ...
        <div class="c-container">
          <div class="c-row">
            <h1 class="p-section-title">Prix et Reconnaissance</h1>
  ...
  <div class="c-full-row home-news">
    <div class="p-band p-band_light">
      <div class="p-page-content">
        <div class="c-container">
          <section>
            <h2 class="p-section-title" id="news">Information</h2>
                ...
                <article class="p-large-news">
                  ...
                  <div class="p-large-news__body">
					<div>
						...
						<a href="<?php the_permalink();?>" class="c-btn c-btn_primary c-btn_wht">Lire la suite</a>
					</div>
                  </div>
                </article>
              <?php endwhile; ?>
	      ...
	      <a href="<?php echo get_permalink( get_option('page_for_posts') );?>" class="c-btn c-btn_primary c-btn_grey">Voir tout</a>
            </div>
